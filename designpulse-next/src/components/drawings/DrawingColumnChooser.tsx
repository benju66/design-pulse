...
interface SortableColumnItemProps {
  column: Column<ProjectSheet, unknown>;
...
interface DrawingColumnChooserProps {
  table: Table<ProjectSheet>;
  projectId: string;
}

export const DrawingColumnChooser = ({ table, projectId }: DrawingColumnChooserProps) => {
