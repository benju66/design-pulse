...
interface SortableColumnItemProps {
  column: Column<ClientBrandStandard, unknown>;
}
...
interface BrandStandardsColumnChooserProps {
  table: Table<ClientBrandStandard>;
  clientId: string;
  onReset?: () => void;
}

export const BrandStandardsColumnChooser = ({ table, clientId: _clientId, onReset }: BrandStandardsColumnChooserProps) => {
  ...
  // Filter out any columns that don't have string headers or shouldn't be configurable (like Actions or Attachments)
