...
import { TextCell, StatusCell, ScopeCell, ImpactCell, PriorityCell, CostCodeCell } from './EditableCell';
...
export const useOpportunityColumnsV2 = (viewMode: string): ColumnDef<Opportunity, unknown>[] => {
